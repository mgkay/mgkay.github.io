...
1. Read `~/.claude/skills/track-changes/VERSION` → first line must be `9.13.1`.
...
> **track-changes v9.13.1 installed successfully — three skills + shared `tc_core` + bundled tools.**
>
