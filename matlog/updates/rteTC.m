...
% Matlog Version 17 26-Apr-2018 (http://www.ise.ncsu.edu/kay/matlog)
...
istrloc = false;
if isfield(tr,'b') || isfield(tr,'e'), istrloc = true; end
...
if ~doTW && exist('out','var'), out = rmfield(out,'Total'); end
